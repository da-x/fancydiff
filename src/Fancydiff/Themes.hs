...
brightBackground = Palette {
    ...
    , p'commitMain       = ColorString "#ee99ee"
    , p'commitFG         = ColorString "#333333"
    , p'commitMergeFG    = ColorString "#555500"
    , p'commitOther      = ColorString "#ffbbff"
    , p'commitMsgByLines = ColorString "#550055"
    , p'diffMain         = ColorString "#a8c0e0"
    , p'diffMainExtra    = ColorString "#a0b8d8"
    , p'diffRemove       = ColorString "#ffcece"
    , p'diffAdd          = ColorString "#ceffce"
    , p'diffMarkRemove   = ColorString "#ffa5a5"
    , p'diffMarkAdd      = ColorString "#a5ffa5"
    , p'diffRemoveFile   = ColorString "#cccccc"
    , p'diffAddFile      = ColorString "#dddddd"
    , p'diffHunkHeaderBG = ColorString "#c8e0f8"
